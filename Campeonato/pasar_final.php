...
$sql = "INSERT INTO final (participante_id_participante, campeonato_id_campeonato) VALUES ($id_participante, $id_campeonato)";
$resultado = mysqli_query($conexion, $sql);

if ($resultado) {
    echo "<script>alert('El participante ha sido pasado a Final.'); window.location.href='visualizar_participante.php?id=$id_campeonato';</script>";
} else {
