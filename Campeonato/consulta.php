...
<body>
    ...
    ?>
    <h1>Agregar Nueva Participante</h1>
    <form action="consulta.php" method="POST" class="formulario_bus">
    ...
    <table class="tabla_principal">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="accion">
                    <?php echo "<a href='agregar_participante.php?id=".$filas['id_cliente']."'>AGREGAR</a>"; ?>
                </td>
            </tr>
            <?php 
            }
