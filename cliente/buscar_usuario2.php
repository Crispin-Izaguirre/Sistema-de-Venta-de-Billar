...
if (isset($_POST['busqueda'])) {
    ...
    $sql = "SELECT * FROM clientes WHERE eliminado = 1 AND socio = 0 
...
<?php
    ...
    ?>
    <h1>Lista de clientes Vetados</h1>
    <form action="buscar_usuario2.php" method="POST" class="formulario_bus">
    ...
    <table class="tabla_principal">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td> <?php echo $filas['razon']; ?> </td>
                <td class="accion">
                    <?php echo "<a href='reintegrar.php?id=".$filas['id_cliente']."'>REINTEGRAR</a>"; ?>
                </td>
            </tr>
            <?php 
                }
