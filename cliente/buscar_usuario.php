...
<body>
    ...
    <form action="buscar_usuario.php" method="POST" class="formulario_bus">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="accion">
                    ...
                    -
                    <?php echo "<a href='hacersocio.php?id=".$filas['id_cliente']."'>SOCIO</a>"; ?>
                    -
                    <?php echo "<a href='eliminarRazon.php?id=".$filas['id_cliente']."'>VETAR</a>"; ?>
                </td>
            </tr>
            <?php 
            }
